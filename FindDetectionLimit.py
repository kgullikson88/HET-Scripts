...
if __name__ == "__main__":
    ...
    for fname in fileList:
        ...
        for snr in snrs:
            ...
            Correlate.PyCorr2(orders2, resolution=60000, outdir=correlation_dir, models=models, stars=stars,
                              temps=temps, gravities=gravities, metallicities=metals, vsini=20 * units.km.to(units.cm),
                              debug=False, outfilebase="%s_SNR%i" % (fname.split(".fits")[0], snr))
