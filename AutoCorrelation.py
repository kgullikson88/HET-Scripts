...
if __name__ == "__main__":
    ...
    for fname in fileList:
        ...
        for vsini in [10, 20, 30, 40]:
            Correlate.AutoCorrelate(orders, resolution=60000, outdir=output_dir, models=model_data, stars=star_list,
                                    temps=temp_list, gravities=gravity_list, metallicities=metal_list,
                                    vsini=vsini * units.km.to(units.cm), debug=True, outfilebase=outfilebase,
                                    corr_mode='valid')
